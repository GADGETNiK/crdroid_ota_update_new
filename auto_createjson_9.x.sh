...
path=/hdd/crdroid7                                                              # Here you will need to specify the path to the crDroid source code folder
...
gapps="https://sourceforge.net/projects/nikgapps/files/Releases/NikGapps-T/07-Nov-2023/NikGapps-core-arm64-13-20231107-signed.zip/download" #https link (leave empty if unused)
